  ...
  return (
    <>
      ...
      <main className="flex min-h-screen items-center justify-center px-4">
        <form
          onSubmit={submit}
          className="glass w-full max-w-sm space-y-4 rounded-2xl p-7"
        >
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-foreground/[0.03] px-3 py-2.5 text-sm outline-none focus:border-ring focus:ring-1 focus:ring-ring"
          />
          <input
            type="email"
            value={actor}
          ...
          <button
            ...
            className="w-full rounded-lg bg-primary px-3 py-2.5 text-sm font-semibold text-primary-foreground shadow-[0_10px_24px_-10px_var(--primary)] transition hover:opacity-90 disabled:opacity-50"
          >
